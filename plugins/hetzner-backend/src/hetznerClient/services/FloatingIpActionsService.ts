...
export class FloatingIpActionsService {
   ...
   * @throws ApiError
   */
  public static getFloatingIpsActions(
    id?: number,
    sort?:
      | 'id'
      | 'id:asc'
   ...
   * @throws ApiError
   */
  public static getFloatingIpsActions1(id: number): CancelablePromise<{
    action: {
      /**
       * ID of the Action.
       */
   ...
   * @throws ApiError
   */
  public static getFloatingIpsActions2(
    id: number,
    sort?:
      | 'id'
      | 'id:asc'
   ...
   * @throws ApiError
   */
  public static postFloatingIpsActionsAssign(
    id: number,
    requestBody?: {
      /**
   ...
   * @throws ApiError
   */
  public static postFloatingIpsActionsChangeDnsPtr(
    id: number,
    requestBody?: {
      /**
   ...
   * @throws ApiError
   */
  public static postFloatingIpsActionsChangeProtection(
    id: number,
    requestBody?: {
      /**
   ...
   * @throws ApiError
   */
  public static postFloatingIpsActionsUnassign(id: number): CancelablePromise<{
    action: {
      /**
       * ID of the Action.
       */
   ...
   * @throws ApiError
   */
  public static getFloatingIpsActions3(
    id: number,
    actionId: number,
  ): CancelablePromise<{
    action: {
