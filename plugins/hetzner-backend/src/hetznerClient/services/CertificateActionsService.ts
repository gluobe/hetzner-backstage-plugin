...
export class CertificateActionsService {
  /**
   * Get all Actions
   ...
   * @throws ApiError
   */
  public static getCertificatesActions(
    id?: number,
    sort?:
      | 'id'
      | 'id:asc'
   ...
   * @throws ApiError
   */
  public static getCertificatesActions1(id: number): CancelablePromise<{
    action: {
      /**
       * ID of the Action.
       */
   ...
   * @throws ApiError
   */
  public static getCertificatesActions2(
    id: number,
    sort?:
      | 'id'
      | 'id:asc'
   ...
   * @throws ApiError
   */
  public static postCertificatesActionsRetry(id: number): CancelablePromise<{
    action: {
      /**
       * ID of the Action.
       */
   ...
   * @throws ApiError
   */
  public static getCertificatesActions3(
    id: number,
    actionId: number,
  ): CancelablePromise<{
    action: {
