...
export class FirewallActionsService {
  /**
   * Get all Actions
   ...
   * @throws ApiError
   */
  public static getFirewallsActions(
    id?: number,
    sort?:
      | 'id'
      | 'id:asc'
   ...
   * @throws ApiError
   */
  public static getFirewallsActions1(id: number): CancelablePromise<{
    action: {
      /**
       * ID of the Action.
       */
   ...
   * @throws ApiError
   */
  public static getFirewallsActions2(
    id: number,
    sort?:
      | 'id'
      | 'id:asc'
   ...
   * @throws ApiError
   */
  public static postFirewallsActionsApplyToResources(
    id: number,
    requestBody?: {
      /**
   ...
   * @throws ApiError
   */
  public static postFirewallsActionsRemoveFromResources(
    id: number,
    requestBody?: {
      /**
   ...
   * @throws ApiError
   */
  public static postFirewallsActionsSetRules(
    id: number,
    requestBody?: {
      /**
       * Array of rules.
   ...
   * @throws ApiError
   */
  public static getFirewallsActions3(
    id: number,
    actionId: number,
  ): CancelablePromise<{
    action: {
