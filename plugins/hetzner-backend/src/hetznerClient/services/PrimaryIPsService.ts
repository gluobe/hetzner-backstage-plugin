...
export class PrimaryIPsService {
  /**
   * Get all Primary IPs
   ...
   * @throws ApiError
   */
  public static postPrimaryIps(requestBody?: {
    /**
     * Name of the Resource. Must be unique per Project.
     */
    name: string;
   ...
   * @throws ApiError
   */
  public static getPrimaryIps1(id: number): CancelablePromise<{
    primary_ip: {
      /**
       * ID of the Primary IP.
       */
   ...
   * @throws ApiError
   */
  public static deletePrimaryIps(id: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/primary_ips/{id}',
      path: {
