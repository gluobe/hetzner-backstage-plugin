...
export class ImageActionsService {
   ...
   * @throws ApiError
   */
  public static getImagesActions(
    id?: number,
    sort?:
      | 'id'
      | 'id:asc'
   ...
   * @throws ApiError
   */
  public static getImagesActions1(id: number): CancelablePromise<{
    action: {
      /**
       * ID of the Action.
       */
   ...
   * @throws ApiError
   */
  public static getImagesActions2(
    id: number,
    sort?:
      | 'id'
      | 'id:asc'
   ...
   * @throws ApiError
   */
  public static postImagesActionsChangeProtection(
    id: number,
    requestBody?: {
      /**
   ...
   * @throws ApiError
   */
  public static getImagesActions3(
    id: number,
    actionId: number,
  ): CancelablePromise<{
    action: {
