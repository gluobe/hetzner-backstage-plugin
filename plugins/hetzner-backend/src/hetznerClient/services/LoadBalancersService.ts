...
export class LoadBalancersService {
   ...
   * @throws ApiError
   */
  public static getLoadBalancers(
    sort?:
      | 'id'
      | 'id:asc'
      | 'id:desc'
   ...
   * @throws ApiError
   */
  public static postLoadBalancers(requestBody?: {
    /**
   ...
   * @throws ApiError
   */
  public static getLoadBalancers1(id: number): CancelablePromise<{
    load_balancer: {
      /**
       * ID of the Load Balancer.
       */
   ...
   * @throws ApiError
   */
  public static putLoadBalancers(
    id: number,
    requestBody?: {
      /**
   ...
   * @throws ApiError
   */
  public static deleteLoadBalancers(id: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/load_balancers/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public static getLoadBalancersMetrics(
    id: number,
    type:
      | 'open_connections'
