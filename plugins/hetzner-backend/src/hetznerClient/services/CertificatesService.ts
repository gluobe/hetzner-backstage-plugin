...
export class CertificatesService {
   ...
   * @throws ApiError
   */
  public static postCertificates(requestBody?: {
    /**
   ...
   * @throws ApiError
   */
  public static getCertificates1(id: number): CancelablePromise<{
    certificate: {
      /**
       * ID of the Certificate.
       */
   ...
   * @throws ApiError
   */
  public static deleteCertificates(id: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/certificates/{id}',
      path: {
