...
export class VolumesService {
   ...
   * @throws ApiError
   */
  public static postVolumes(requestBody?: {
    /**
   ...
   * @throws ApiError
   */
  public static getVolumes1(id: number): CancelablePromise<{
    volume: {
      /**
       * ID of the Volume.
       */
   ...
   * @throws ApiError
   */
  public static deleteVolumes(id: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/volumes/{id}',
      path: {
