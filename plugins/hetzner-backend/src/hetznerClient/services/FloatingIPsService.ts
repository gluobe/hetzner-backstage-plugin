...
export class FloatingIPsService {
   ...
   * @throws ApiError
   */
  public static postFloatingIps(requestBody?: {
    /**
     * Floating IP type
     */
    type: 'ipv4' | 'ipv6';
   ...
   * @throws ApiError
   */
  public static getFloatingIps1(id: number): CancelablePromise<{
    floating_ip: {
      /**
       * ID of the Floating IP.
       */
   ...
   * @throws ApiError
   */
  public static deleteFloatingIps(id: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/floating_ips/{id}',
      path: {
