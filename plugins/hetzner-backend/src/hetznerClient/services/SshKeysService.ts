...
export class SshKeysService {
   ...
   * @throws ApiError
   */
  public static postSshKeys(requestBody?: {
    /**
     * Name of the SSH key
     */
    name: string;
   ...
   * @throws ApiError
   */
  public static getSshKeys1(id: number): CancelablePromise<{
    ssh_key: {
      /**
       * ID of the SSH Key.
       */
   ...
   * @throws ApiError
   */
  public static deleteSshKeys(id: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/ssh_keys/{id}',
      path: {
