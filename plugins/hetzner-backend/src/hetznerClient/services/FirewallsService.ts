...
export class FirewallsService {
   ...
   * @throws ApiError
   */
  public static postFirewalls(requestBody?: {
    /**
     * Name of the [Firewall](#firewalls).
     *
     * Limited to a maximum of 128 characters.
   ...
   * @throws ApiError
   */
  public static getFirewalls1(id: number): CancelablePromise<{
    firewall: {
      /**
       * ID of the Firewall.
       */
   ...
   * @throws ApiError
   */
  public static deleteFirewalls(id: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/firewalls/{id}',
      path: {
