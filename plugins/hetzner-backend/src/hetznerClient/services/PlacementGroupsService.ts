...
export class PlacementGroupsService {
   ...
   * @throws ApiError
   */
  public static postPlacementGroups(requestBody?: {
    /**
   ...
   * @throws ApiError
   */
  public static getPlacementGroups1(id: number): CancelablePromise<{
    placement_group: {
      /**
       * ID of the Placement Group.
       */
   ...
   * @throws ApiError
   */
  public static deletePlacementGroups(id: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/placement_groups/{id}',
      path: {
