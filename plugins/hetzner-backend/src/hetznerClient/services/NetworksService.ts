...
export class NetworksService {
   ...
   * @throws ApiError
   */
  public static postNetworks(requestBody?: {
    /**
     * Name of the [Network](#networks).
     */
    name: string;
   ...
   * @throws ApiError
   */
  public static getNetworks1(id: number): CancelablePromise<{
    network?: {
      /**
       * ID of the [Network](#networks).
       */
   ...
   * @throws ApiError
   */
  public static deleteNetworks(id: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/networks/{id}',
      path: {
