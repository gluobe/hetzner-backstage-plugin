...
export declare class VolumeActionsService {
    /**
     * Get all Actions
     ...
     * @throws ApiError
     */
    static getVolumesActions(id?: number, sort?: 'id' | 'id:asc' | 'id:desc' | 'command' | 'command:asc' | 'command:desc' | 'status' | 'status:asc' | 'status:desc' | 'started' | 'started:asc' | 'started:desc' | 'finished' | 'finished:asc' | 'finished:desc', status?: 'running' | 'success' | 'error', page?: number, perPage?: number): CancelablePromise<{
        actions: Array<{
            /**
             * ID of the Action.
             */
     ...
     * @throws ApiError
     */
    static getVolumesActions1(id: number): CancelablePromise<{
        action: {
            /**
             * ID of the Action.
             */
     ...
     * @throws ApiError
     */
    static getVolumesActions2(id: number, sort?: 'id' | 'id:asc' | 'id:desc' | 'command' | 'command:asc' | 'command:desc' | 'status' | 'status:asc' | 'status:desc' | 'started' | 'started:asc' | 'started:desc' | 'finished' | 'finished:asc' | 'finished:desc', status?: 'running' | 'success' | 'error', page?: number, perPage?: number): CancelablePromise<{
        actions: Array<{
            /**
             * ID of the Action.
             */
     ...
     * @throws ApiError
     */
    static postVolumesActionsAttach(id: number, requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static postVolumesActionsChangeProtection(id: number, requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static postVolumesActionsDetach(id: number): CancelablePromise<{
        action: {
            /**
             * ID of the Action.
             */
     ...
     * @throws ApiError
     */
    static postVolumesActionsResize(id: number, requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static getVolumesActions3(id: number, actionId: number): CancelablePromise<{
        action: {
            /**
             * ID of the Action.
             */
