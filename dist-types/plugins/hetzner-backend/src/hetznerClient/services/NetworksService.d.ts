...
export declare class NetworksService {
     ...
     * @throws ApiError
     */
    static getNetworks(sort?: 'id' | 'id:asc' | 'id:desc' | 'name' | 'name:asc' | 'name:desc' | 'created' | 'created:asc' | 'created:desc', name?: string, labelSelector?: string, page?: number, perPage?: number): CancelablePromise<{
        networks: Array<{
            /**
     ...
     * @throws ApiError
     */
    static postNetworks(requestBody?: {
        /**
         * Name of the [Network](#networks).
         */
        name: string;
     ...
     * @throws ApiError
     */
    static getNetworks1(id: number): CancelablePromise<{
        network?: {
            /**
             * ID of the [Network](#networks).
             */
     ...
     * @throws ApiError
     */
    static putNetworks(id: number, requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static deleteNetworks(id: number): CancelablePromise<void>;
}
