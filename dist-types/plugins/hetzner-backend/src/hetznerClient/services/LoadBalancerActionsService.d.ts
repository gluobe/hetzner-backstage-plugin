...
export declare class LoadBalancerActionsService {
    /**
     * Get all Actions
     ...
     * @throws ApiError
     */
    static getLoadBalancersActions(id?: number, sort?: 'id' | 'id:asc' | 'id:desc' | 'command' | 'command:asc' | 'command:desc' | 'status' | 'status:asc' | 'status:desc' | 'started' | 'started:asc' | 'started:desc' | 'finished' | 'finished:asc' | 'finished:desc', status?: 'running' | 'success' | 'error', page?: number, perPage?: number): CancelablePromise<{
        actions: Array<{
            /**
             * ID of the Action.
             */
     ...
     * @throws ApiError
     */
    static getLoadBalancersActions1(id: number): CancelablePromise<{
        action: {
            /**
             * ID of the Action.
             */
     ...
     * @throws ApiError
     */
    static getLoadBalancersActions2(id: number, sort?: 'id' | 'id:asc' | 'id:desc' | 'command' | 'command:asc' | 'command:desc' | 'status' | 'status:asc' | 'status:desc' | 'started' | 'started:asc' | 'started:desc' | 'finished' | 'finished:asc' | 'finished:desc', status?: 'running' | 'success' | 'error', page?: number, perPage?: number): CancelablePromise<{
        actions: Array<{
            /**
             * ID of the Action.
             */
     ...
     * @throws ApiError
     */
    static postLoadBalancersActionsAddService(id: number, requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static postLoadBalancersActionsAddTarget(id: number, requestBody?: {
        /**
         * Type of the resource
         */
     ...
     * @throws ApiError
     */
    static postLoadBalancersActionsAttachToNetwork(id: number, requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static postLoadBalancersActionsChangeAlgorithm(id: number, requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static postLoadBalancersActionsChangeDnsPtr(id: number, requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static postLoadBalancersActionsChangeProtection(id: number, requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static postLoadBalancersActionsChangeType(id: number, requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static postLoadBalancersActionsDeleteService(id: number, requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static postLoadBalancersActionsDetachFromNetwork(id: number, requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static postLoadBalancersActionsDisablePublicInterface(id: number): CancelablePromise<{
        action: {
            /**
             * ID of the Action.
             */
     ...
     * @throws ApiError
     */
    static postLoadBalancersActionsEnablePublicInterface(id: number): CancelablePromise<{
        action: {
            /**
             * ID of the Action.
             */
     ...
     * @throws ApiError
     */
    static postLoadBalancersActionsRemoveTarget(id: number, requestBody?: {
        /**
         * Type of the resource
         */
        type: 'server' | 'label_selector' | 'ip';
     ...
     * @throws ApiError
     */
    static postLoadBalancersActionsUpdateService(id: number, requestBody?: {
        /**
         * Protocol of the Load Balancer
         */
        protocol?: 'tcp' | 'http' | 'https';
     ...
     * @throws ApiError
     */
    static getLoadBalancersActions3(id: number, actionId: number): CancelablePromise<{
        action: {
            /**
             * ID of the Action.
             */
