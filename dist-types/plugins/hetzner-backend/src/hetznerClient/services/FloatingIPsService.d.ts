...
export declare class FloatingIPsService {
    /**
     ...
     * @throws ApiError
     */
    static getFloatingIps(name?: string, labelSelector?: string, sort?: 'id' | 'id:asc' | 'id:desc' | 'created' | 'created:asc' | 'created:desc', page?: number, perPage?: number): CancelablePromise<{
        floating_ips: Array<{
            /**
     ...
     * @throws ApiError
     */
    static postFloatingIps(requestBody?: {
        /**
         * Floating IP type
         */
        type: 'ipv4' | 'ipv6';
     ...
     * @throws ApiError
     */
    static getFloatingIps1(id: number): CancelablePromise<{
        floating_ip: {
            /**
             * ID of the Floating IP.
             */
     ...
     * @throws ApiError
     */
    static putFloatingIps(id: number, requestBody?: {
        /**
         * Description of the Resource.
         */
        description?: string | null;
     ...
     * @throws ApiError
     */
    static deleteFloatingIps(id: number): CancelablePromise<void>;
}
