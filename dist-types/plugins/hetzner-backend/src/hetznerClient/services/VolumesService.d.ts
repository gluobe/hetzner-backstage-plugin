...
export declare class VolumesService {
     ...
     * @throws ApiError
     */
    static getVolumes(status?: 'available' | 'creating', sort?: 'id' | 'id:asc' | 'id:desc' | 'name' | 'name:asc' | 'name:desc' | 'created' | 'created:asc' | 'created:desc', name?: string, labelSelector?: string, page?: number, perPage?: number): CancelablePromise<{
        volumes: Array<{
            /**
             * ID of the Volume.
             */
     ...
     * @throws ApiError
     */
    static postVolumes(requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static getVolumes1(id: number): CancelablePromise<{
        volume: {
            /**
             * ID of the Volume.
             */
     ...
     * @throws ApiError
     */
    static putVolumes(id: number, requestBody?: {
        /**
         * New Volume name
         */
        name?: string;
     ...
     * @throws ApiError
     */
    static deleteVolumes(id: number): CancelablePromise<void>;
}
