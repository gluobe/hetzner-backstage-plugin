...
export declare class FirewallsService {
     ...
     * @throws ApiError
     */
    static getFirewalls(sort?: 'id' | 'id:asc' | 'id:desc' | 'name' | 'name:asc' | 'name:desc' | 'created' | 'created:asc' | 'created:desc', name?: string, labelSelector?: string, page?: number, perPage?: number): CancelablePromise<{
        firewalls: Array<{
            /**
             * ID of the Firewall.
             */
     ...
     * @throws ApiError
     */
    static postFirewalls(requestBody?: {
        /**
         * Name of the [Firewall](#firewalls).
         *
         * Limited to a maximum of 128 characters.
     ...
     * @throws ApiError
     */
    static getFirewalls1(id: number): CancelablePromise<{
        firewall: {
            /**
             * ID of the Firewall.
             */
     ...
     * @throws ApiError
     */
    static putFirewalls(id: number, requestBody?: {
        /**
         * Name of the [Firewall](#firewalls).
         *
         * Limited to a maximum of 128 characters.
     ...
     * @throws ApiError
     */
    static deleteFirewalls(id: number): CancelablePromise<void>;
}
