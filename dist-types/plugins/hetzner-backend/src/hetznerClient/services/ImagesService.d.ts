...
export declare class ImagesService {
     ...
     * @throws ApiError
     */
    static getImages(sort?: 'id' | 'id:asc' | 'id:desc' | 'name' | 'name:asc' | 'name:desc' | 'created' | 'created:asc' | 'created:desc', type?: 'system' | 'app' | 'snapshot' | 'backup', status?: 'available' | 'creating' | 'unavailable', boundTo?: string, includeDeprecated?: boolean, name?: string, labelSelector?: string, architecture?: 'x86' | 'arm', page?: number, perPage?: number): CancelablePromise<{
        images: Array<{
            /**
             * ID of the Image.
             */
     ...
     * @throws ApiError
     */
    static getImages1(id: number): CancelablePromise<{
        image?: {
            /**
             * ID of the Image.
             */
     ...
     * @throws ApiError
     */
    static putImages(id: number, requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static deleteImages(id: number): CancelablePromise<void>;
}
