...
export declare class ServersService {
     ...
     * @throws ApiError
     */
    static getServers(name?: string, labelSelector?: string, sort?: 'id' | 'id:asc' | 'id:desc' | 'name' | 'name:asc' | 'name:desc' | 'created' | 'created:asc' | 'created:desc', status?: 'running' | 'initializing' | 'starting' | 'stopping' | 'off' | 'deleting' | 'migrating' | 'rebuilding' | 'unknown', page?: number, perPage?: number): CancelablePromise<{
        servers: Array<{
            /**
             * ID of the Server.
             */
     ...
     * @throws ApiError
     */
    static postServers(requestBody?: {
        /**
     ...
     * @throws ApiError
     */
    static getServers1(id: number): CancelablePromise<{
        server?: {
            /**
             * ID of the Server.
             */
     ...
     * @throws ApiError
     */
    static putServers(id: number, requestBody?: {
        /**
         * New name to set
         */
        name?: string;
     ...
     * @throws ApiError
     */
    static deleteServers(id: number): CancelablePromise<{
        action?: {
            /**
             * ID of the Action.
             */
     ...
     * @throws ApiError
     */
    static getServersMetrics(id: number, type: 'cpu' | 'disk' | 'network', start: string, end: string, step?: string): CancelablePromise<{
        metrics: {
            /**
